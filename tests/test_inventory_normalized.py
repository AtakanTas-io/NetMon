...
def test_inventory_identity_survives_ip_change(tmp_path, monkeypatch):
    ...
    dev = {"ip": "192.168.1.10", "mac": "AA:BB:CC:DD:EE:01", "hostname": "PC-01", "vendor": "Test", "type": "computer", "status": "online"}
    inv = {"status": "Success", "ip_address": dev["ip"], "mac_address": dev["mac"], "computer_name": dev["hostname"], "inventory_source": "Agentless Discovery"}
