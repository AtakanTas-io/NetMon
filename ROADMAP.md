...
- Temiz bir test ağıyla kısa kurulum videosu hazırlamak
...
- Envanter ve trafik değişimleri için geçmiş karşılaştırması eklemek
- Alanların veri kaynağını gösteren dışa aktarma raporları hazırlamak
- Masaüstü kabuğu olmadan çalışacak web kurulumu için örnek yapılandırma eklemek

Bir özellik çalışır durumda olmadan README'de tamamlanmış gibi listelenmez.
